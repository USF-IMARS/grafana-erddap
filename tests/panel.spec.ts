...
//   await panelEditPage.setVisualization('Grafana-Erddap');
...
//   await panelEditPage.datasource.set(ds.name);
//   await panelEditPage.setVisualization('Grafana-Erddap');
//   await panelEditPage.collapseSection('Grafana-Erddap');
//   await expect(page.getByTestId('simple-panel-circle')).toBeVisible();
//   const seriesCounterLabel = panelEditPage.getByGrafanaSelector(
//     selectors.components.PanelEditor.OptionsPane.fieldLabel('Grafana-Erddap Show series counter')
//   );
